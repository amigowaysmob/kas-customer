...
//   TwoDimensionalScrollableDemo(this.data, {super.key});
...
//           child:
//               TextViewSmall(title: data![vicinity.yIndex - 1].date.toString(),textcolor: appColor,));
//     } 
//     else if (vicinity.xIndex == 1) {
//       return Padding(
//           padding: const EdgeInsets.only(left: 8, right: 8),
//           child:
//               TextViewSmall(title: data![vicinity.yIndex - 1].metalType.toString(),textcolor: appColor,));
//     }
//     else if (vicinity.xIndex == 2) {
//       return Padding(
//           padding: const EdgeInsets.only(left: 8, right: 8),
//           child:
//               TextViewSmall(title: data![vicinity.yIndex - 1].type.toString(),textcolor: appColor,));
//     } else if (vicinity.xIndex == 3) {
//       return Padding(
//           padding: const EdgeInsets.only(left: 8, right: 8),
//           child: TextViewSmall(
//               title: data![vicinity.yIndex - 1].credit.toString(),textcolor: appColor,));
//     } else if (vicinity.xIndex == 4) {
//       return Padding(
//           padding: const EdgeInsets.only(left: 8, right: 8),
//           child: TextViewSmall(
//               title: data![vicinity.yIndex - 1].debit.toString(),textcolor: appColor,));
//     } else if (vicinity.xIndex == 5) {
//       return Padding(
//           padding: const EdgeInsets.only(left: 8, right: 8),
//           child: TextViewSmall(
//               title: data![vicinity.yIndex - 1].balance.toString(),textcolor: appColor,));
