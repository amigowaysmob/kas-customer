...
class _TermsScreenState extends State<TermsScreen> {
  ...
  void initState() {
    super.initState();
    context.read<TermsCubit>().login(AboutUsRequestModel(seourl: 'terms-and-conditions',
    lang: ApiConstant.langCode));
  }
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: TitleAppBarWidget(title:"Terms & Conditions"),
    ...
    if( state.networkStatusEnum==NetworkStatusEnum.loaded){
     return
       ...
       child:Column(
        ...
        children: [
        TextViewLarge(title: "Terms & Conditions",textcolor: appColor,fontWeight: FontWeight.w800,),
