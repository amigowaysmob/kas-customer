...
@RoutePage()
class ProofEditScreen extends HookWidget {
  UserData? userData;
 ProofEditScreen({this.userData});
...
final GlobalKey<FormState> formKey = GlobalKey<FormState>();
  ...
  if (userData?.aadharCardFront != null && userData!.aadharCardFront!.isNotEmpty) {
    apiFrontValue.value = userData!.aadharCardFront!;
    isF.value = true;
    apiAF.value = userData!.aadharCardFront!;
   
   
  }
  
  // Check for PAN front value
  if (userData?.panCardFront != null && userData!.panCardFront!.isNotEmpty) {
    apiFrontValue.value = userData!.panCardFront!;
    isF.value = true;
    apipF.value = userData!.panCardFront!;
...
void isApiBack() {
  ...
  if (userData?.aadharCardBack != null && userData!.aadharCardBack!.isNotEmpty) {
    apiBackValue.value = userData!.aadharCardBack!;
    isB.value = true;
    apiAB.value = userData!.aadharCardBack!;
    
   
  }
  
  // Check for PAN back value
  if (userData?.panCardBack != null && userData!.panCardBack!.isNotEmpty) {
  ...
  if (image != null) {
    ...
    imagePath.value = imagePath.value; // This line is to force a rebuild.
       ...
       print('apiAF${apiAF.value}');
                                         print('apiAB${apiAB.value}');
                                          print('apipF${apipF.value}');
                                           print('apiPB${apiPB.value}');
      print('formData.aadhar front ${aadharFront.value}');
      print('formData.aashr back ${aadharBack.value}');
      print('formData.pan front ${panFront.value}');
      print('formData.pan back ${panBack.value}');
    }
 ...
 void register() async {
    ...
    if (formKey.currentState!.validate() ) {
     ...
     aadharCardFront: aadharFront.value,
     aadharCardBack: aadharBack.value,
     panCardFront: panFront.value,
     panCardBack: panBack.value,customer_kyc: '1'
     ));
    ...
    return Scaffold(
      appBar: TitleAppBarWidget(title: '${d?.idProofDetails??'ID proof details'}'),
      body: Form(
        key:formKey,
