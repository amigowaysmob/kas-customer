...
class Step1Form extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    TextEditingController? mobileController = useTextEditingController();
     TextEditingController nameController = useTextEditingController();
        ...
        TextEditingController emailController = useTextEditingController();
         TextEditingController gardianController = useTextEditingController();

         nameController.text=data?.customerData?.name??'';
    mobileController.text=data?.customerData?.phoneNumber??'';
         wpController.text=data?.customerData?.phoneNumber??'';
         emailController.text=data?.customerData?.email??'';
       
    var isWp=useState(false);
    var isNum=useState(false);
    var switched=useState('No');
    ...
    formData?.home_collection=switched.value;
              ...
              children: [
                ...
                TextForm(
                  ...
                  controller: nameController,
                   readOnly: true,
                  onSaved: (value) => formData.fullName = nameController.text,
                ),
                vericalSpaceLarge,
                TextForm(
                  keyboardType: TextInputType.name,
                ...
                TextForm(
                    ...
                    onSaved: (value) => formData.phoneNumber = mobileController.text,
                    type: 'mobileNumber'),
...
numError.value=null;
                ...
                TextForm(
                    ...
                    onSaved: (value) => formData.whatsappNumber = wpController.text,
                    type: 'mobileNumber'),
...
wpError.value=null;
                ...
                //   },
                // ),
                  DropDownWidget(items:[langData?.male??'Male',langData?.female??'Female',],
                        labelText: '${langData?.gender}*',isValidate: true,
                         validationMessage:langData?.genderRequired,
                         onChanged: (p0){
                          if(p0==langData?.male)
...
//                 ),
//                onComplete: (p0){
// formData.birthday=dobController.text;
//                },
//               ),
              TextForm(
                  ...
                  labelText: langData?.dateOfBirth,
                  // validating: _validateUsername,
                  onSaved: (value) => formData.birthday= value,
                  controller: dobController,
                  hintText: 'DD/MM/YYYY',
                  type: 'dob',
                ),
...
//                 Row(
//                   children: [
//                     TextViewMedium(name:'Do you want home collection? Yes/No' ,fontWeight: FontWeight.bold,),
...
//               switched.value='Yes';
// print(formData.home_collection);
//             }
//             else{
