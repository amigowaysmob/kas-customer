...
class Step4Form extends HookWidget {
  ...
  Widget build(BuildContext context) {
    print('isExistsss $isExists');
    final count = useState(1);
var errorText=useState<String?>(null);
...
//         builder: (context, state) {
          ...
          String? dailyDue(){
            ...
            return langData?.dailyDue;
              ...
              return langData?.weeklyDue;
              
            }
            else 
            return langData?.monthlyDue;
          }
          return
       ...
       isExists!=true?     Column(
            ...
            Row(
              ...
              children: [
                ...
                vericalSpaceMedium,
      formData?.plan_type!="flexible" ?         Column(
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                  ...
                  children: [
                    ...
                    TextForm(keyboardType: TextInputType.number,
                                ...
                                errorText: errorText.value,
                                 onSaved: (value) => formData.payable_amount = value,
                                validating: _validateAmount,
                                // onChanged: (p0){
                                //   if(int.parse(data?.planData?[0].values?.first.amountLimit??'0')<int.parse(p0??'0')){
                                //     errorText.value='Please Enter the value below ₹${data?.planData?[0].values?.first.amountLimit}';
                                //   }
                                //   else{
